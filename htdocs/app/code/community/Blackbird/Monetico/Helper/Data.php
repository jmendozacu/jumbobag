...
class Blackbird_Monetico_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * @return string
     */
    public function getPaymentFormAction($environment)
    {
        return Mage::getSingleton('blackbird_monetico/configProvider')->getPaymentFormAction($environment);
    }
