...
class Blackbird_Monetico_Model_Method_CofidisFxcb extends Blackbird_Monetico_Model_Method_Abstract
{
    ...
    {
        return Mage::getUrl('monetico/cofidisFx/success', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('monetico/cofidisFx/error', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('monetico/cofidisFx/notify', array('_secure' => true));
    }
    ...
    public function getOrderPlaceRedirectUrl()
    {
        ...
        return Mage::getUrl('monetico/cofidisFx/redirect');
    }
